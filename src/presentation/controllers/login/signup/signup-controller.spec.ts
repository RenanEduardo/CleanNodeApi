...
import { AccountModel, AddAccount, AddAcccountParams, Validation, AuthenticationParams, Authentication } from './signup-controller-protocols'
...
const makeAddAccount = (): AddAccount => {
  class AddAccountStub implements AddAccount {
    async add (account: AddAcccountParams): Promise<AccountModel> {
...
const makeSut = (): SutTypes => {
  ...
  const sut = new SignUpController(addAccountStub, validationStub, authenticatonStub)
  return {
    sut,
    addAccountStub,
    validationStub,
